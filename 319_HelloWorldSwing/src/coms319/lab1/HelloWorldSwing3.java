...
public class HelloWorldSwing3 {
    ...
    public static void main(String[] args) {
        ...
        inputField.setBounds(44, 15, 94, 24);
        ...
        clearAfterTime.setBounds(313, 13, 38, 28);
